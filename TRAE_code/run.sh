#!/bin/bash
# Run from TRAE_code/ directory: bash run.sh
# Based on README recommended command + visual teacher alignment
...
torchrun --standalone --nnodes=1 --nproc_per_node=1 finetune.py \
    ...
    --run_id_note="VLA-Adapter-align--${data_name}--${current_time}"